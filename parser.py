...
class Parser:
    def __init__(self):
        # self.proteins_file_name = "per-protein.h5"
        # self.embeddings_file_name = "uniprotkb_AND_reviewed_true_2023_08_22.tsv"
        self.uni_proteins = {}
    ...
    def read_ecs(self):
        ...
        # dependency on read_embeddings run first -> fix this later

        with open("uniprotkb_AND_reviewed_true_2023_08_22.tsv") as f:
